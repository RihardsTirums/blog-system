...
<div class="relative bg-white p-6 rounded-lg shadow-lg">
    ...
    <p class="text-sm text-gray-500 mt-2">
        ...
        at {{ $post->created_at->timezone(config('app.timezone'))->format('H:i:s') }}
    </p>
    ...
    <p class="text-xs text-yellow-500 mt-1">
        ...
        at {{ $post->updated_at->timezone(config('app.timezone'))->format('H:i:s') }}
    </p>
    @endif

    <div class="absolute top-4 right-4 flex items-center text-gray-500 space-x-1">
